...
constexpr auto qt_meta_stringdata_CLASSCustomMoveWidgetENDCLASS = QtMocHelpers::stringData(
    "CustomMoveWidget"
);
#else  // !QT_MOC_HAS_STRING_DATA
struct qt_meta_stringdata_CLASSCustomMoveWidgetENDCLASS_t {
...
constexpr auto qt_meta_stringdata_CLASSCBaseDialogENDCLASS = QtMocHelpers::stringData(
    "CBaseDialog"
);
#else  // !QT_MOC_HAS_STRING_DATA
struct qt_meta_stringdata_CLASSCBaseDialogENDCLASS_t {
...
constexpr auto qt_meta_stringdata_CLASSCMessageBoxENDCLASS = QtMocHelpers::stringData(
    "CMessageBox",
    "SltTimerOut",
    ""
);
...
constexpr auto qt_meta_stringdata_CLASSCInputDialogENDCLASS = QtMocHelpers::stringData(
    "CInputDialog"
);
#else  // !QT_MOC_HAS_STRING_DATA
struct qt_meta_stringdata_CLASSCInputDialogENDCLASS_t {
