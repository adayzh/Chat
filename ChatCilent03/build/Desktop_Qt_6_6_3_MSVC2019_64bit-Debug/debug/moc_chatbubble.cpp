...
constexpr auto qt_meta_stringdata_CLASSBubbleListENDCLASS = QtMocHelpers::stringData(
    "BubbleList",
    "sig_setCurrentIndex",
    "",
    "currIndex",
...
constexpr auto qt_meta_stringdata_CLASSBubbleListPrivateENDCLASS = QtMocHelpers::stringData(
    "BubbleListPrivate",
    "sig_setMaximum",
    "",
    "max",
