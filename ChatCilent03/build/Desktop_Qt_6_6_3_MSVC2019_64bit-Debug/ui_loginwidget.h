...
"}"));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/resource/common/ic_login_cfg.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/resource/common/ic_min.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/resource/common/ic_close_white.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QObject::connect(btnWinMin_2, &QPushButton::clicked, LoginWidget, qOverload<>(&QWidget::showMinimized));
        QObject::connect(btnWinClose_2, &QPushButton::clicked, LoginWidget, qOverload<>(&QWidget::close));
        QObject::connect(btnWinMin, &QPushButton::clicked, LoginWidget, qOverload<>(&QWidget::showMinimized));
        QObject::connect(btnWinClose, &QPushButton::clicked, LoginWidget, qOverload<>(&QWidget::close));
