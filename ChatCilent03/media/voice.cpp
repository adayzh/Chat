...
//    const char* login_params         = "appid = 573c0f60, work_dir = .";
    ...
    // loginParames.append(MyApp::m_strDataPath.toUtf8());

    // //合成的语音文件名称
    // QByteArray dataCfg = "voice_name = ";     // 播报人
    // dataCfg.append(wave_t.speeker.toUtf8());  // 转换为 QByteArray
    // dataCfg.append(", background_sound = ");
    // dataCfg.append(QByteArray::number(wave_t.bgs));  // 转换为 QByteArray
    // dataCfg.append(", text_encoding = utf8");
    // dataCfg.append(", sample_rate = ");
    // dataCfg.append(wave_t.rate.toUtf8());  // 转换为 QByteArray
    // dataCfg.append(", speed = ");
    // dataCfg.append(QByteArray::number(wave_t.speed));  // 转换为 QByteArray
    // dataCfg.append(", volume = ");
    // dataCfg.append(QByteArray::number(wave_t.volume));  // 转换为 QByteArray
    // dataCfg.append(", pitch = ");
    // dataCfg.append(QByteArray::number(wave_t.pitch));  // 转换为 QByteArray
    // dataCfg.append(", rdn = ");
    // dataCfg.append(QByteArray::number(wave_t.rdn));  // 转换为 QByteArray
    ...
    // ret = text_to_speech(wave_t.text.toUtf8().constData(),
