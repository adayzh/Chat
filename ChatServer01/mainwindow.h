...
private slots:
    ...
    void on_btnScorePage_clicked();

    void on_btnUserInfoPage_clicked();

    void on_btnScoreInsertPage_clicked();

    void on_btnUsersPage_clicked();

    void on_btnPasswordPage_clicked();
