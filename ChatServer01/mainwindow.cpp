...
void MainWindow::InitNetwork()
{
    ...
    systemTrayIcon->setIcon(QIcon(":/new/prefix1/resource/images/ic_app.png"));
...
void MainWindow::on_btnScorePage_clicked()
{
ui->stackedWidgetFunc->setCurrentIndex(1);
}


void MainWindow::on_btnUserInfoPage_clicked()
{
    ui->stackedWidgetFunc->setCurrentIndex(0);
}


void MainWindow::on_btnScoreInsertPage_clicked()
{
     ui->stackedWidgetFunc->setCurrentIndex(2);
}


void MainWindow::on_btnUsersPage_clicked()
{
    ui->stackedWidgetFunc->setCurrentIndex(3);
}


void MainWindow::on_btnPasswordPage_clicked()
{
    ui->stackedWidgetFunc->setCurrentIndex(4);
}


void MainWindow::on_btnDataBackup_clicked()
{
    ui->stackedWidgetFunc->setCurrentIndex(5);
}
